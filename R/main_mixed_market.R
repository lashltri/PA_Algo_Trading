...
# The GARCH method is just for comparison purposes 
...
mat_sharpe_garch_comp <- mat_sharpe[, c("BH", "AG", "GARCH")]


#sharpe for main evaluation
mat_sharpe <- mat_sharpe[, setdiff(colnames(mat_sharpe), "GARCH")]
mat_drawdown <- mat_drawdown[, setdiff(colnames(mat_sharpe), "GARCH")]
